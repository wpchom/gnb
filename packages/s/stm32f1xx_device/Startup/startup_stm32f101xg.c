 ...
 * @file        startup_stm32f101xg.c
 * @brief       stm32f101xg startup source
 * @date        2024-05-30
 */
/* Include ----------------------------------------------------------------- */
...
__attribute__((weak, alias("Default_Handler"))) void TIM9_IRQHandler(void);
__attribute__((weak, alias("Default_Handler"))) void TIM10_IRQHandler(void);
__attribute__((weak, alias("Default_Handler"))) void TIM11_IRQHandler(void);
